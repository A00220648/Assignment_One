...
var consolere = require('console-remote-client').connect('console.re','80','a00220648_Assignment_One');
...
function handleRequest(request, response){
    ...
    console.re.log("Current values: Augend="+augend+"Addend="+addend+"Sum="+Sum+);
